...
describe("智能登记流量来源和渠道订单号提取测试", () => {
  ...
  it("应该能提取流量来源(设备微信号)", async () => {
    const text = `
微信群"本部及巡游打款群"的聊天记录如下:

瀛姬沐沐（11-20点 周天周一休息） 18:22
...
`;
    ...
    // 流量来源应该提取设备微信号
    expect(order.trafficSource).toContain("瀛姬沐沐");
  }, 30000);
...
瀛姬秋秋11:00-20:00 14:57

山竹 12.22 20:00-21:30 情趣变装课 黑桃上 晓昔东晨 1888全款微信已付 (上海404) 给老师450 交易单号4200002912202512208697791196
`;
    ...
    expect(order.trafficSource).toContain("瀛姬秋秋");
    expect(order.customerName).toBe("晓昔东晨");
  }, 30000);
