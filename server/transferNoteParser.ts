...
3. **客户名识别规则** - 客户名**不能**是以下任何一种:
   ...
   - 课程名或业务类型(2v2、面销、基础局、女王局、丝袜课、裸足丝袜、问罪、臣服、反转、sp课、埃及艳后等)
   - 包含"单"、"上"、"教室"等后缀的词
   - 包含"报销"、"车费"、"辛苦费"等费用相关词
4. **地点识别**: 地点通常是城市名,可能带括号,例如"(北京)"、"上海"、"武汉单"。
5. **课程识别**: 课程名通常包含"局"、"课"等后缀,或者是"2v2"、"面销"等特殊标记。
6. **费用记录过滤**: 以下类型的文本**不应该**创建订单,应该跳过:
   - 只包含"面销"、"报销"、"车费"、"辛苦费"、"提成"等费用相关词的记录
   - 没有明确的上课时间和课程内容的记录
   - 只是给老师或销售人员的费用支付记录
...
- 示例3: 山竹 12.7 yy面销 2000 (这是费用记录,**不应该创建订单**,应该跳过)
