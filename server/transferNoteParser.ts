...
- 格式: 销售名 日期 时间 课程 老师 客户 金额 备注 地点 教室
- 日期格式: MM.DD (例如: 12.16)
- 时间格式: HH:MM-HH:MM (例如: 15:00-18:30)
- 金额可能包含"已付"、"未付"、"定金"等关键词
- 地点可能在括号中,例如: (北京大兴)
- 有些字段可能缺失

请将以下转账备注解析为JSON数组,每个对象包含以下字段:
- salesperson: 销售人员名字(花名)
- classDate: 上课日期(格式: 2024-MM-DD,年份使用2024)
- classTime: 上课时间(格式: HH:MM-HH:MM)
- deliveryCourse: 课程名称
- deliveryTeacher: 老师名字
- customerName: 客户名字
- paymentAmount: 支付金额(只提取数字,不包含"已付"、"未付"等文字)
- courseAmount: 课程总金额(如果有"未付"金额,计算总额)
- deliveryCity: 上课城市
- deliveryRoom: 上课教室/房间号
- notes: 其他备注信息
            ...
            properties: {
              orders: {
                ...
                items: {
                  ...
                  required: ["customerName", "paymentAmount"],
